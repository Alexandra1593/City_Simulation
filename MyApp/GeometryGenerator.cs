...
{
    /// <summary>
    /// Created using the model provided in Introduction to 3D Game Programming by Frank Luna
    /// </summary>
    public static class GeometryGenerator
    {
        ...
        public static MeshData CreateBox(float width, float height, float depth, int numSubdivisions)
        {
            ...
            {
                // This represents the front face index data.
                0, 1, 2, 0, 2, 3,
                // This represents the back face index data.
                4, 5, 6, 4, 6, 7,
                // This represents the top face index data.
                8, 9, 10, 8, 10, 11,
                // This represents the bottom face index data.
                12, 13, 14, 12, 14, 15,
                //This represents the left face index data
                16, 17, 18, 16, 18, 19,
                // This represents the right face index data
                20, 21, 22, 20, 22, 23
            });
        ...
        //Create a rectangle based on CreateBox() method. After all, a rectangle is a box with depth = 0.
        public static MeshData CreateRectangle(float height, float depth, int numSubdivisions)
        {
            return CreateBox(0, height, depth, numSubdivisions);
        }
